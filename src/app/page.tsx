	...
	return (
		<main className="justify-center bg-pinky-white">
			<div className="flex-col lg:flex lg:flex-row">
				...
				<div className="w-full basis-1/4  bg-pink-grey rounded-bl-3xl rounded-tl-3xl bg-gradient-radial from-toolkit-start-pink from-10% via-toolkit-middle-pink via-80% to-toolkit-end-pink">
					<SelfCareToolkit />
				</div>
			</div>
		</main>
